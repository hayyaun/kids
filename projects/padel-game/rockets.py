...
def check_ball_hit_rocket(ball: turtle.Turtle, left_rocket: turtle.Turtle, right_rocket: turtle.Turtle):
    ...
    if abs(ball_x - left_rocket_x) < hit_threshold_x and abs(ball_y - left_rocket_y) < hit_threshold_y:
    ...
    if abs(ball_x - right_rocket_x) < hit_threshold_x and abs(ball_y - right_rocket_y) < hit_threshold_y:
        ball.dx *= -1
